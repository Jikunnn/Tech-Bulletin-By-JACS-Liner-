...
function getUsernameByUserId($userId)
{
    ...
    $sql = "SELECT admin_username FROM admin WHERE admin_id = '$userId'";
    $result = $conn->query($sql);
...
function getUserIdByUsername($username)
{
    ...
    $sql = "SELECT admin_id FROM admin WHERE admin_username = '$username'";
    $result = $conn->query($sql);
...
function displayPostsAndReplies($postsAndReplies)
{
    foreach ($postsAndReplies as $post) {
        echo "<div class='post'>";
        echo "<p>Post ID: " . $post['post_id'] . "</p>";
        echo "<p>Content: " . $post['post_content'] . "</p>";
        echo "<p>Posted By: " . getUsernameByUserId($post['post_by']) . " (User ID: " . $post['post_by'] . ")" . "</p>";
        echo "<p>Topic: " . getTopicTitleByTopicId($post['post_topic']) . "</p>";
        ...
        foreach ($post['replies'] as $reply) {
            ...
            echo "<p>Posted By: " . getUsernameByUserId($reply['reply_by']) . " (User ID: " . $reply['reply_by'] . ")" . "</p>";
...
<body>
	...
	<div class="container1">
        ...
        <div class="user-info">
			...
			<form class="Manage" method="POST" action="">
        ...
        <form method="POST" action="">
            <div class="form-group">
                ...
                <label for="post_content"><br>Post Content:</label>
